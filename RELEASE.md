...
- Check the contents on https://github.com/omisai-tech/szamlazzhu-agent/compare/{latest_version}...master and update the [changelog](CHANGELOG.md) file with the modifications on this release
