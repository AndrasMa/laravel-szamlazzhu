...
class SzamlaAgentException extends \Exception
{
    ...
    public const NO_AGENT_INSTANCE_WITH_USERNAME = 'Nincs ilyen felhasználónévvel Számla Agent példányosítva!';

    public const NO_AGENT_INSTANCE_WITH_APIKEY = 'Nincs ilyen kulccsal Számla Agent példányosítva!';
    ...
    public const XML_FILE_SAVE_FAILED = 'XML fálj mentése sikertelen';
